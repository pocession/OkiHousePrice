...
Where is the highest price felling in and where is the city with the highest potential? Let's plot the both price (house age adjusted, per pyeong) and growth rate (since 2007<sup>1</sup>) on the map. Again, to our suprisingly, ot Naha city. Uruma city has the highest growth rate and Okinawaa city has the highest price!
